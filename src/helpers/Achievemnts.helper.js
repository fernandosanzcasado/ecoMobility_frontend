...
export const getLogoCO2 = (achievementdata) => {
  if (achievementdata < 0) return 0;
  else if (achievementdata < 0) return 1;
  else if (achievementdata < 0) return 2;
  else if (achievementdata < 0) return 3;
  else if (achievementdata < 0) return 4;
  else if (achievementdata >= 0) return 5;
};
...
export const getNextGoalCO2 = (achievementdata) => {
  if (achievementdata < 0) return 0;
  else if (achievementdata < 0) return 0;
  else if (achievementdata < 0) return 0;
  else if (achievementdata < 0) return 0;
  else if (achievementdata < 0) return 0;
  else if (achievementdata >= 0) return 0;
